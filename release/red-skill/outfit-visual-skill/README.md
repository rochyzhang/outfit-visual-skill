...
SK01 remains the realistic minimal flat-lay contract: a naturally laid-out outfit on a slightly cooler, cleaner neutral-grey indoor cement/concrete floor with casual layered placement, soft low-saturation daylight, soft-edged grounded shadows, real still-life photography feel, and lightweight English arrow/leader-line product notes rather than a pure white cutout collage or poster. SK02 is now a clean editorial flat-lay information contract: human-absent, clothing-only, arranged on a pale neutral studio surface with cleaner, tidier, more controlled placement than SK01, clear product separation, deliberate spacing, a restrained English top title, systematic product labels, simple hierarchy, subtle contact shadows, minimal deliberate overlap, and polished negative space. SK03 is a no-clear-face main-look plus numbered item-breakdown contract anchored to its own 03 reference: it may include a model-based main look cropped below the chin or head out of frame, but must keep separated product zones with short English item titles and a clean look-guide / gift-guide hierarchy. SK04 remains the prop-styling contract with one hero chair or simple prop organizing the outfit, but the scene is now a cleaner, lighter grey-white indoor studio wall/floor with a small English top information row and chair-supported human-presence garment arrangement rather than a cement/concrete room. SK05 is re-anchored to its own Japanese catalog reference: quiet, soft, restrained, warm-neutral, paper-like lifestyle catalog pacing and product-led catalog composition with English-only generated text, no Japanese text, no fake Japanese glyphs, no Korean text, and no redesign into a SK03 item board or SK06 poster. SK06 is re-anchored to its own Korean Street Editorial reference: one complete flat 2D human-silhouette Look on muted sage/dusty green with generic fictional title, setup/look title, white hand-drawn product callouts, and a very short poster tagline while remaining clothing-only with no real human, face, skin, street-photo model, mannequin realism, or 3D invisible body.
