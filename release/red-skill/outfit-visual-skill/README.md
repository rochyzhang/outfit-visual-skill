...
SK01 remains the realistic minimal flat-lay contract: a naturally laid-out outfit on a slightly cooler, cleaner neutral-grey indoor cement/concrete floor with casual layered placement, soft low-saturation daylight, soft-edged grounded shadows, real still-life photography feel, and richer lightweight Title Case English arrow/leader-line product notes rather than a pure white cutout collage or poster. SK02 is a clean editorial flat-lay information contract: human-absent, clothing-only, arranged on a pale neutral studio surface with cleaner, tidier, more controlled placement than SK01, clear product separation, deliberate spacing, a restrained English top title, systematic product labels, simple hierarchy, subtle contact shadows, minimal deliberate overlap, and polished negative space. SK03 is a structured look-breakdown contract: one primary styled Look plus separate product/component breakdown, clean English sans-serif labels, and automatic reflow when optional items such as hats or bags are present, with no free-floating slogans, handwriting, books, thumbnails, or detail boxes. SK04 remains the prop-styling contract with one hero chair or simple prop organizing the outfit, but the scene is a clean premium cool grey-white indoor studio wall/floor with soft even ambient light, no visible sunbeam/window-light streak, one small text-only English top information row, and a chair-supported outfit display. In SK04 the chair is display support, not a hidden seated body; human-referential reading comes only from garment order and outfit relationship, not body shape. Tops stay empty, trousers drape from fabric gravity and chair contact, bags remain independent product styling, and shoes are product placement rather than invisible feet. SK05 is a Japanese magazine/catalog page contract with English product information, limited short Japanese editorial accent text, and no hand-drawn callouts, books, slogans, thumbnails, detail boxes, or product zoom/detail-box columns. SK06 is a flat staged Korean editorial contract: one complete laid-out Look on muted sage arranged in normal wearing order only: top/hat at upper-body/head position, trousers directly below, shoes at the bottom with both toe tips facing left, bag near the upper-body/shoulder area, and any hat brim/front facing the same leftward direction. SK06 is not a product breakdown, not random flat-lay scattering, not a standing invisible body, and not clothing worn by a hidden body. SK06 keeps all garments empty, flat, unworn, and non-inflated while using coordinated placement and short English per-product callouts with white hand-drawn numbers, arrows, and labels.
