...
- 01 may use only `examples/visual/01-minimal-flat-lay.png`
- 02 may use only `examples/visual/02-clean-editorial-flat-lay.png`
- 03 may use only `examples/visual/03-look-breakdown.png`
- 04 may use only `examples/visual/04-prop-styling.png`
- 05 may use only `examples/visual/05-japanese-catalog.png`
- 06 may use only `examples/visual/06-korean-street-editorial.png`

For Use 01, explicitly ignore `02-clean-editorial-flat-lay.png` and every other packaged Skill reference. For Use 02, explicitly ignore `01-minimal-flat-lay.png` and every other packaged Skill reference. Apply the same one-to-one isolation to 03, 04, 05, and 06.
...
- Reference image path: `examples/visual/01-minimal-flat-lay.png`
...
- Composition rule: One primary styled Look with separate clothing pieces and accessories displayed around or beside it; clear hierarchy, generous negative space, and approved look breakdown structure. If recommended products such as a hat or bag are present, automatically reflow and redistribute the layout so items do not crowd, overlap, cover each other, or squeeze the main Look. Keep SK03 distinct from SK01/SK02 flat-lay label systems, SK05 Japanese catalog pages, and SK06 hand-drawn Korean street callouts.
...
- Graphic rule: Minimal English editorial typography, small item numbers, thin restrained sans-serif labels, subtle product annotations, and clean component captions. Keep visible text limited to product roles, item names, and short factual descriptions. Do not add free-floating handwritten words, lifestyle slogans, decorative motivational phrases, extra book props, unrelated mini images, zoom detail boxes, thumbnails, enlarged product detail frames, SK01/SK02 arrow-label styling, SK05 magazine typography, or SK06 white hand-drawn callouts.
...
- Forbidden elements: copied reference-image products, invented missing products, non-English generated labels, cluttered poster layout, wrong Skill/output type, free-floating handwritten words, decorative slogans, Daily Outfit-style text, extra books, unrelated mini images, detail boxes, zoom frames, thumbnails, close-up panels, crowded optional accessories, overlapping products, SK05 catalog typography, SK06 hand-drawn callouts.
- Post-generation QA: Verify at least 3 user products, primary look plus item breakdown, optional hat/bag reflow without crowding or overlap, English-only visible text, no extra free-floating phrases, no unrelated mini images/detail boxes, and product identity preserved.
- Reference image path: `examples/visual/03-look-breakdown.png`
...
- Reference image path: `examples/visual/04-prop-styling.png`
...
- Graphic rule: Japanese lifestyle magazine/catalog typography with English as the primary product-information language, elegant product descriptions, precise alignment, generous white space, refined margins, and warm editorial hierarchy. Small amounts of short Japanese editorial accent text are allowed as decorative magazine language, but Japanese must be limited, visually integrated, and not dominant. Do not generate hand-drawn text, white sketch arrows, SK06-style handwritten labels, large blocks of Japanese text, unreadable Japanese-like noise, fake brand names, URLs, logos, extra slogans, book props, vertical product zoom/detail-box columns, multiple cropped close-up thumbnails, technical detail panels, or spec-sheet feeling.
- Product Fidelity rule: Catalog styling and typography must not cover, modify, or replace product-defining details.
- Forbidden elements: generic Japanese model portrait, large blocks of Japanese text, unreadable Japanese-like noise, arbitrary Japanese typography, invented products, missing required products, copied reference-image products, product zoom/detail-box column, multiple cropped close-up thumbnails, technical detail panels, spec-sheet feeling, breakdown-board feeling, hand-drawn typography, white sketch arrows, SK06 handwritten callouts, extra slogans, book props, unrelated decorative objects, detail boxes, thumbnails, close-up frames.
...
- Reference image path: `examples/visual/06-korean-street-editorial.png`
