...
- Composition rule: Outfit naturally arranged on or around one visually dominant hero chair or similarly simple hero prop; slightly surreal is allowed only when physically believable. The chair is a display prop, styling support, flat display structure, and visual organizer for garments. It is not a hidden torso, pelvis, thighs, legs, seated body, standing body, or mannequin. The outfit must interact naturally with the single anchor and form a human-referential styling arrangement by garment placement only: garments may be supported, draped, folded, layered, or positioned so the total arrangement loosely suggests torso and lower-body regions through product relationships, while remaining product-first and display-focused. Tops or inner tops may rest or drape over the chair while staying visibly empty, following fabric gravity with no chest expansion, torso cavity, stretched shoulder anatomy, or worn-body tension. If an outer garment exists, layer it naturally over or around the top and drape or hang it on the chair without invisible shoulder/body volume or mannequin-like jacket structure. Trousers may have a waistband resting on the seat, chair edge, or under the top area, and legs may drape downward over the front or side with folds created by fabric weight, denim stiffness, garment cut, chair contact, gravity, and natural bunching. Trousers must stay empty and must not form inflated thighs, hidden knee shapes, calf volume, rounded leg tubes, sitting-leg anatomy, or a seated-body pose. Bags may hang from or rest against the chair as product styling, not as if carried by an invisible person. Shoes should be placed near the chair or lower composition area as clean product placement, naturally grouped, and not positioned as invisible feet or forced into SK06 standing-pose logic. Avoid simply placing independent products around a prop; the prop should organize the outfit spatially without distorting uploaded products. Do not add secondary furniture or prop clusters, visible body parts, face, skin, a full mannequin, hidden mannequin, chest cavity, waist volume, thigh volume, knee volume, calf volume, body-inflated garment tension, seated invisible-person structure, standing silhouette, or a strong 3D invisible-person effect.
