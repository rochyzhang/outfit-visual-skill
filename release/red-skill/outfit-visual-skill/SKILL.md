...
- Intent: Korean independent-brand / Seoul editorial with a flat staged outfit arranged into a clear standing human-pose silhouette. The garments form one complete human-shaped Look through product placement, wearing-order hierarchy, and pose gesture only while remaining laid flat, graphic, and distinct from SK02's clean separated studio flat lay. This is not generic Korean model portrait photography, not random decorative product placement, and not invisible-person styling.
