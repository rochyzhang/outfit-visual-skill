...
assert.match(sk02Composition, /clear product separation, restrained spacing/);
...
assert.match(section(sk02Prompt, "06 SCENE"), /early approved 01 flat-lay result/);
assert.match(section(sk02Prompt, "06 SCENE"), /lighter, more controlled studio surface/);
assert.match(section(sk02Prompt, "06 SCENE"), /clean white, soft grey, or very pale neutral studio/);
assert.match(section(sk02Prompt, "06 SCENE"), /Keep SK02 cleaner and more product-separated than SK01/);
assert.match(section(sk02Prompt, "06 SCENE"), /Avoid cement-floor realism/);
...
assert.match(section(sk02Prompt, "15 NEGATIVE / PROHIBITED BEHAVIOR"), /clean, separated, controlled, and editorial/);
