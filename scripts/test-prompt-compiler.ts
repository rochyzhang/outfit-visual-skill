...
assert.match(section(sk05Prompt, "04 COMPOSITION"), /calm Japanese lifestyle catalog feeling/);
assert.match(section(sk05Prompt, "04 COMPOSITION"), /soft editorial flat-lay or near-flat outfit presentation/);
assert.match(section(sk05Prompt, "04 COMPOSITION"), /gentle white space/);
assert.match(section(sk05Prompt, "04 COMPOSITION"), /must not become SK03's numbered breakdown board/);
assert.match(section(sk05Prompt, "04 COMPOSITION"), /SK06's Korean independent-brand poster/);
...
assert.match(section(sk05Prompt, "15 NEGATIVE / PROHIBITED BEHAVIOR"), /SK03 numbered breakdown board/);
...
for (const prompt of nonSk03To06Prompts) {
  ...
  assert.doesNotMatch(prompt, /calm Japanese lifestyle catalog feeling/);
...
assert.match(section(sk06Prompt, "04 COMPOSITION"), /not as SK02's clean separated studio flat lay, SK03's breakdown board, or SK05's calm catalog page/);
...
assert.match(section(sk06Prompt, "15 NEGATIVE / PROHIBITED BEHAVIOR"), /Do not turn SK06 into SK03's item breakdown board/);
assert.match(section(sk06Prompt, "15 NEGATIVE / PROHIBITED BEHAVIOR"), /SK05's calm Japanese catalog page/);
