...
assert.match(section(sk04Prompt, "04 COMPOSITION"), /Interpret the SK04 reference as a product display system/);
assert.match(section(sk04Prompt, "04 COMPOSITION"), /styling prop, display support, flat structural support, and presentation device/);
...
assert.match(section(sk04Prompt, "04 COMPOSITION"), /chair-supported outfit display/);
assert.match(section(sk04Prompt, "04 COMPOSITION"), /garments arranged in natural wearing order on a display chair/);
...
assert.match(section(sk04Prompt, "04 COMPOSITION"), /upper-garment and lower-garment zones/);
...
assert.match(section(sk04Prompt, "04 COMPOSITION"), /waistband may be supported by the chair seat, chair edge, or top-contact area/);
