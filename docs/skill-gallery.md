...
- Canonical visual behavior: Product-first still life with clothing styled around one hero chair or simple hero prop in a clean premium cool grey-white studio wall/floor environment with a simple neutral backdrop, soft even ambient studio light, no visible sunbeam/window-light streak, no extra furniture clutter, one small English top information row, and a chair-based human-referential styling arrangement by garment placement only. The chair is display support, not a hidden seated body. Tops stay empty, outerwear may drape or layer naturally, trousers drape from fabric gravity and chair contact without thigh/knee/calf anatomy, bags remain product styling, and shoes remain product placement rather than invisible feet.
...
- Canonical visual behavior: Dusty-sage flat staged Korean editorial with mandatory white hand-drawn English per-product callouts. The garments form one complete laid-out Look with a clearer standing human-pose silhouette through flat wearing-order placement only: top at upper body, trousers directly below, shoes as the coordinated end of the implied legs, and bag near the upper-body/shoulder side. It includes readable shoulder/torso/hip/leg gesture, controlled asymmetry, and coordinated shoe direction while remaining flat, empty, graphic, and not worn by an invisible person.
- Required inputs: `bottom`, `shoes`, and at least one of `top` or `outer`.
- Forbidden elements: visible person, mannequin, Korean text, Hangul, standing invisible-person styling, worn-body presentation, inflated garment volume, shoes posed like invisible feet, random opposing shoe directions, shoes detached from the implied pose, random flat-lay scattering, accessory placement with no wearing-order logic, rigid straight-line flat lay with no pose, independent product breakdown, generic catalog grid, invented products, copied reference-image products, missing required products.
