...
function buildProhibitedBehavior(config: GenerationConfig) {
  ...
  if (config.skillOrigin?.id === "SK04_PROP_STYLING") {
    ...
    prohibited.push("Do not show a real human, face, skin, full mannequin, hidden mannequin, or strong 3D invisible-person body; SK04 may suggest a human-shaped styling composition through chair-supported garment placement only. Do not inflate garments with invisible chest, waist, thigh, knee, or calf volume. Do not let the top information row become a large poster headline or cover the products.");
  }
