...
function buildProhibitedBehavior(config: GenerationConfig) {
  ...
  if (config.skillOrigin?.id === "SK06_KOREAN_STREET_EDITORIAL") {
    ...
    prohibited.push("Do not make garments look worn by invisible feet, legs, torso, shoulders, or body; no internal body volume, chest cavity, inflated shoulders, waist volume, thigh volume, knee volume, calf volume, front/back leg depth, or realistic invisible-body anatomy.");
    ...
    prohibited.push("Do not break the top-to-trouser-to-shoe hierarchy; the top must read as upper body, trousers directly below as lower body, and shoes as the coordinated end of the implied legs.");
    ...
    prohibited.push("Do not reduce SK06 to a rigid straight-line flat lay or simple product flat lay; the flat staged outfit needs a clear standing human-pose gesture with shoulder, torso, hip, and leg direction.");
    ...
    prohibited.push("Do not detach shoes from the implied pose; shoes should visually continue the trouser-leg directions while remaining staged products, not invisible feet.");
  ...
  if (config.skillOrigin?.id === "SK04_PROP_STYLING") {
    ...
    prohibited.push("Do not show a real human, face, skin, full mannequin, hidden mannequin, strong 3D invisible-person body, invisible seated person, seated body pose, or SK06-style standing silhouette; SK04 may suggest a human-referential styling arrangement through chair-supported garment placement only.");
    ...
    prohibited.push("Do not make tops look worn by an invisible seated person; no chest expansion, torso cavity, stretched shoulder anatomy, or worn-body tension.");
    prohibited.push("Do not inflate trousers with invisible thigh, knee, or calf anatomy; no rounded leg tubes, sitting-leg anatomy, seated-body pose encoded into trousers, or trouser legs shaped like someone is inside them. Natural 3D fabric folds from gravity, denim stiffness, garment cut, chair contact, and bunching are allowed.");
